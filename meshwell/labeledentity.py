        ...
        if self.resolutions:
            ...
            for resolutionspec in self.resolutions:
                ...
                if self.get_dim() == 3:
                    ...
                    entity_resolution = min(resolutionspec.resolution_volumes, default_resolution)

                    # Check condition on volumes
                    entities = [
                        volume_tag
                        for volume_tag in self.get_tags()
                        if resolutionspec.min_volumes < self.model.occ.getMass(3, volume_tag) < resolutionspec.max_volumes
                    ]
                    ...
                    boundaries = [
                        ...
                        if resolutionspec.min_area_surfaces < self.model.occ.getMass(2, surface_tag) < resolutionspec.max_area_surfaces
                    ]

                    boundary_resolution = min(resolutionspec.resolution_surfaces, entity_resolution)
                    ...
                    curves = [
                        ...
                        for c in cs
                        if resolutionspec.min_length_curves < self.model.occ.getMass(1, c) < resolutionspec.max_length_curves
                    ]
                    ...
                    entity_resolution = min(resolutionspec.resolution_surfaces, default_resolution)
                    ...
                    boundaries = [
                        ...
                        if resolutionspec.min_length_curves < self.model.occ.getMass(1, curve_tag) < resolutionspec.max_length_curves
                    ]

                    boundary_resolution = min(resolutionspec.resolution_curves, entity_resolution)
                ...
                if boundaries:
                    ...
                    if resolutionspec.sizemax_curves and resolutionspec.distmax_curves:
                        self.model.mesh.field.setNumber(
