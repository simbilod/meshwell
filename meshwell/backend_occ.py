...
class OccBackend:
    ...
    def __init__(self, progress_bars: bool = False, **kwargs):
    ...
    def save_checkpoint(self, path: Path) -> None:
        ...
        occ_to_xao(self.results, path, progress_bars=self.progress_bars)

    def to_gmsh_model(self, model_manager: Any) -> None:
        """Inject OCC shapes into GMSH model."""
        inject_occ_entities_into_gmsh(
            self.results, model_manager, progress_bars=self.progress_bars
        )
